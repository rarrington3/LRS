...
import InitialFindingDetails from './InitialFindingDetails';

describe('review/components/InitialFindingDetails.js', () => {
    ...
    it('should be creatable', async(() => {
        TestBed.compileComponents().then(() => {
            const fixture = TestBed.createComponent(InitialFindingDetails);
