...
import EditFindingSourceCause from './EditFindingSourceCause';

describe('review/components/EditFindingSourceCause.js', () => {
    ...
    it('should be creatable', async(() => {
        TestBed.compileComponents().then(() => {
            const fixture = TestBed.createComponent(EditFindingSourceCause);
