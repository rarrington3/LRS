...
import NonInitialFindingDetails from './NonInitialFindingDetails';

describe('review/components/NonInitialFindingDetails.js', () => {
    ...
    it('should be creatable', async(() => {
        TestBed.compileComponents().then(() => {
            const fixture = TestBed.createComponent(NonInitialFindingDetails);
