...
describe('preloader/errorhandler.js', function () {
    ...
    beforeEach(function () {
        ...
        spyOn(errorDialog, 'reload');
    });

    xit('reports and displays a dialog for unhandled exceptions', function() {
    ...
    it('reports & displays errors raised with a display message', function(){
        ...
        expect(reporterArg.errorId).toBeDefined();
        ...
        expect(dialogArg.id).toEqual(reporterArg.errorId);
    });

    xit('reports but does not display errors raised without a display message', function(){
