...
import ReviewsCompletedTeamSidebar from './ReviewsCompletedTeamSidebar';

describe('workload/components/ReviewsCompletedTeamSidebar.js', () => {
    ...
    it('should be creatable', async(() => {
        TestBed.compileComponents().then(() => {
            const fixture = TestBed.createComponent(ReviewsCompletedTeamSidebar);
