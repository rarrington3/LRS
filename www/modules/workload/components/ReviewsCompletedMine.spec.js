...
import ReviewsCompletedMine from './ReviewsCompletedMine';

describe('workload/components/ReviewsCompletedMine.js', () => {
    ...
    it('should be creatable', async(() => {
        TestBed.compileComponents().then(() => {
            const fixture = TestBed.createComponent(ReviewsCompletedMine);
