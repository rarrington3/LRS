...
import MyTeamWorkloadSidebar from './MyTeamWorkloadSidebar';

describe('workload/components/MyTeamWorkloadSidebar.js', () => {
    ...
    it('should be creatable', async(() => {
        TestBed.compileComponents().then(() => {
            const fixture = TestBed.createComponent(MyTeamWorkloadSidebar);
