...
import WorkloadCompletedBatchesSidebar from './WorkloadCompletedBatchesSidebar';

describe('workload/components/WorkloadCompletedBatchesSidebar.js', () => {
    ...
    it('should be creatable', async(() => {
        TestBed.compileComponents().then(() => {
            const fixture = TestBed.createComponent(WorkloadCompletedBatchesSidebar);
