...
import WorkloadCompletedBatches from './WorkloadCompletedBatches';

describe('workload/components/WorkloadCompletedBatches.js', () => {
    ...
    it('should be creatable', async(() => {
        TestBed.compileComponents().then(() => {
            const fixture = TestBed.createComponent(WorkloadCompletedBatches);
