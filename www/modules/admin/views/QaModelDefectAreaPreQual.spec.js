...
import QaModelDefectAreaPreQual from './QaModelDefectAreaPreQual';

describe('admin/components/QaModelDefectAreaPreQual.js', () => {
    ...
    it('should be creatable', async(() => {
        TestBed.compileComponents().then(() => {
            const fixture = TestBed.createComponent(QaModelDefectAreaPreQual);
