...
import QaModelDefectAreaQaTree from './QaModelDefectAreaQaTree';

describe('admin/components/QaModelDefectAreaQaTree.js', () => {
    ...
    it('should be creatable', async(() => {
        TestBed.compileComponents().then(() => {
            const fixture = TestBed.createComponent(QaModelDefectAreaQaTree);
