...
import QaModelDefectAreaPreQualEdit from './QaModelDefectAreaPreQualEdit';

describe('admin/components/QaModelDefectAreaPreQualEdit.js', () => {
    ...
    it('should be creatable', async(() => {
        TestBed.compileComponents().then(() => {
            const fixture = TestBed.createComponent(QaModelDefectAreaPreQualEdit);
