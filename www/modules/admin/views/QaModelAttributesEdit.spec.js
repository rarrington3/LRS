...
import QaModelAttributesEdit from './QaModelAttributesEdit';

describe('admin/components/QaModelAttributesEdit.js', () => {
    ...
    it('should be creatable', async(() => {
        TestBed.compileComponents().then(() => {
            const fixture = TestBed.createComponent(QaModelAttributesEdit);
