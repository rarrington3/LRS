...
import ReviewLevelReviewerDeadlines from './ReviewLevelReviewerDeadlines';

describe('admin/components/ReviewLevelReviewerDeadlines.js', () => {
    ...
    it('should be creatable', async(() => {
        TestBed.compileComponents().then(() => {
            const fixture = TestBed.createComponent(ReviewLevelReviewerDeadlines);
