...
import QaModelDefectAreaRemediation from './QaModelDefectAreaRemediation';

describe('admin/components/QaModelDefectAreaRemediation.js', () => {
    ...
    it('should be creatable', async(() => {
        TestBed.compileComponents().then(() => {
            const fixture = TestBed.createComponent(QaModelDefectAreaRemediation);
