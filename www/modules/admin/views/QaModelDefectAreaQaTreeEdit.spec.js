...
import QaModelDefectAreaQaTreeEdit from './QaModelDefectAreaQaTreeEdit';

describe('admin/components/QaModelDefectAreaQaTreeEdit.js', () => {
    ...
    it('should be creatable', async(() => {
        TestBed.compileComponents().then(() => {
            const fixture = TestBed.createComponent(QaModelDefectAreaQaTreeEdit);
