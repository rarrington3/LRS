...
import LenderIncreasedSelection from './LenderIncreasedSelection';

describe('admin/components/LenderIncreasedSelection.js', () => {
    ...
    it('should be creatable', async(() => {
        TestBed.compileComponents().then(() => {
            const fixture = TestBed.createComponent(LenderIncreasedSelection);
