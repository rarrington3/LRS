...
import QaModelDefectAreaSeverities from './QaModelDefectAreaSeverities';

describe('admin/components/QaModelDefectAreaSeverities.js', () => {
    ...
    it('should be creatable', async(() => {
        TestBed.compileComponents().then(() => {
            const fixture = TestBed.createComponent(QaModelDefectAreaSeverities);
