...
import QaModelDefectAreaSources from './QaModelDefectAreaSources';

describe('admin/components/QaModelDefectAreaSources.js', () => {
    ...
    it('should be creatable', async(() => {
        TestBed.compileComponents().then(() => {
            const fixture = TestBed.createComponent(QaModelDefectAreaSources);
