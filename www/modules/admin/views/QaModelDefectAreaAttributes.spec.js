...
import QaModelDefectAreaAttributes from './QaModelDefectAreaAttributes';

describe('admin/components/QaModelDefectAreaAttributes.js', () => {
    ...
    it('should be creatable', async(() => {
        TestBed.compileComponents().then(() => {
            const fixture = TestBed.createComponent(QaModelDefectAreaAttributes);
