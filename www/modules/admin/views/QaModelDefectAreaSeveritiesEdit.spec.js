...
import QaModelDefectAreaSeveritiesEdit from './QaModelDefectAreaSeveritiesEdit';

describe('admin/components/QaModelDefectAreaSeveritiesEdit.js', () => {
    ...
    it('should be creatable', async(() => {
        TestBed.compileComponents().then(() => {
            const fixture = TestBed.createComponent(QaModelDefectAreaSeveritiesEdit);
