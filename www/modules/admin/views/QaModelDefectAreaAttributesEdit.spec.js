...
import QaModelDefectAreaAttributesEdit from './QaModelDefectAreaAttributesEdit';

describe('admin/components/QaModelDefectAreaAttributesEdit.js', () => {
    ...
    it('should be creatable', async(() => {
        TestBed.compileComponents().then(() => {
            const fixture = TestBed.createComponent(QaModelDefectAreaAttributesEdit);
