...
import EditReviewLocation from './EditReviewLocation';

describe('admin/components/EditReviewLocation.js', () => {
    ...
    it('should be creatable', async(() => {
        TestBed.compileComponents().then(() => {
            const fixture = TestBed.createComponent(EditReviewLocation);
