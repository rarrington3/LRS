...
import QaModelDefectAreaRemediationEdit from './QaModelDefectAreaRemediationEdit';

describe('admin/components/QaModelDefectAreaRemediationEdit.js', () => {
    ...
    it('should be creatable', async(() => {
        TestBed.compileComponents().then(() => {
            const fixture = TestBed.createComponent(QaModelDefectAreaRemediationEdit);
