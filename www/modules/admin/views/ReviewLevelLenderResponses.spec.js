...
import ReviewLevelLenderResponses from './ReviewLevelLenderResponses';

describe('admin/components/ReviewLevelLenderResponses.js', () => {
    ...
    it('should be creatable', async(() => {
        TestBed.compileComponents().then(() => {
            const fixture = TestBed.createComponent(ReviewLevelLenderResponses);
