...
import LenderReviewsCompletedSidebar from './LenderReviewsCompletedSidebar';

describe('lender/components/LenderReviewsCompletedSidebar.js', () => {
    ...
    it('should be creatable', async(() => {
        TestBed.compileComponents().then(() => {
            const fixture = TestBed.createComponent(LenderReviewsCompletedSidebar);
