...
import LenderCompletedBatches from './LenderCompletedBatches';

describe('lender/components/LenderCompletedBatches.js', () => {
    ...
    it('should be creatable', async(() => {
        TestBed.compileComponents().then(() => {
            const fixture = TestBed.createComponent(LenderCompletedBatches);
