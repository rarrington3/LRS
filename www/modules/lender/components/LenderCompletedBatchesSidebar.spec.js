...
import LenderCompletedBatchesSidebar from './LenderCompletedBatchesSidebar';

describe('lender/components/LenderCompletedBatchesSidebar.js', () => {
    ...
    it('should be creatable', async(() => {
        TestBed.compileComponents().then(() => {
            const fixture = TestBed.createComponent(LenderCompletedBatchesSidebar);
