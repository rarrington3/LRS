...
import LenderReviewDataSidebar from './lenderReviewDataSidebar';
import { REVIEW_PROVIDERS } from '../../review/services/';

describe('lender/components/LenderReviewDataSidebar.js', () => {
    ...
    it('should be creatable', async(() => {
        TestBed.compileComponents().then(() => {
            const fixture = TestBed.createComponent(LenderReviewDataSidebar);
