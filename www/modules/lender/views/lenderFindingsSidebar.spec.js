...
import LenderFindingsSidebar from './lenderFindingsSidebar';

describe('lender/views/lenderFindingsSidebar.js', () => {
    ...
    it('should be creatable', async(() => {
        TestBed.compileComponents().then(() => {
            const fixture = TestBed.createComponent(LenderFindingsSidebar);
