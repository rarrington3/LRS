...
import LenderReviewContainer from './lenderReviewContainer';

describe('lender/views/lenderReviewContainer.js', () => {
    ...
    it('should be creatable', async(() => {
        TestBed.compileComponents().then(() => {
            const fixture = TestBed.createComponent(LenderReviewContainer);
