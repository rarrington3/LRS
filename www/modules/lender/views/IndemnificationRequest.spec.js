...
import IndemnificationRequest from './IndemnificationRequest';

describe('lender/components/IndemnificationRequest.js', () => {
    ...
    it('should be creatable', async(() => {
        TestBed.compileComponents().then(() => {
            const fixture = TestBed.createComponent(IndemnificationRequest);
