                    ...
                    middleware: function(connect) {
                        return [
                            ...
                            require('connect-route')(function(app) {
                                ...
                                var dir = path.resolve(grunt.config('settings.dir.apiroot'));
    ...
    grunt.registerTask('server', function(target) {
        ...
        grunt.config.merge({
            watch: {
                ...
                options: {
                    livereload: grunt.config('connect')[target].options.port + 10
                }
            }
        });
        ...
        switch (target) {
            ...
            case 'test':
                ...
                break;
            case 'apidesigner':
                // no need to do anything extra before launching the server
                break;
            default:
