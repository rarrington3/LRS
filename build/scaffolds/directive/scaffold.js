module.exports = function (grunt) {
    ...
    grunt.event.on('scaffold.directive.executed', function () {
        var Context = require('../../tasks/libs/TemplateContext'),
            context = new Context(),
            scaffold = grunt.config('scaffold'),
            settings = grunt.config('settings'),
            path = require('path'),
            name = context.camelCase(scaffold.module).toUpperCase() + '_DIRECTIVES',
            indexFile = path.resolve(settings.dir.app, 'modules', scaffold.module, 'directives', 'index.js'),
